...
function jogar() {
    ...
    if (placar == 3) {
        document.getElementById('img').innerHTML = "<img src='download.jpg'>"
        document.getElementById('parabens').innerHTML = `${nick1} é o vencedor, parabéns`
        document.getElementById("travar").style.display = 'none';
        document.getElementById("rei").style.display = "block";
    }else{
        if (placar2 == 3) {
            document.getElementById('img').innerHTML = "<img src='download.jpg'>"
            document.getElementById('parabens').innerHTML = `${nick2} é o vencedor, parabéns`
            document.getElementById("travar").style.display = 'none';
            document.getElementById("rei").style.display = "block";
        }
    }
